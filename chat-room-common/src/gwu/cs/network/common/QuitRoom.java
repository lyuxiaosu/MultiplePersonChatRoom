...
public class QuitRoom extends ChatRoomCommandMessage {
	private int messageType = 11;
	public String roomID;
	public String userID;

	public QuitRoom(String userID, String roomID) {
		this.userID = userID;
		this.roomID = roomID;
	}
	...
	public static QuitRoom unSerilize(byte[] stream) {
		...
		return new QuitRoom(userID, roomID);
	}
